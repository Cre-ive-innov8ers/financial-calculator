...
while True:
    ...
    print("____________________________________________FINANCIAL CALCULATOR_____________________________________")
    ...
    if period == '1':#Period in Months
        while True:
            print("____________________________________________CREATIVE INNOVATORS______________________________________")
            print("____________________________________________FINANCIAL CALCULATOR_____________________________________")
            print("__________________________________________NB. Period is in months____________________________________")
            ...
            if choice == '1':# Investment
                print(f"____________________________________________Investment Calculator____________________________________\n")
                while True:
                    ...
                    if option == '1':#Compound
                        print(f"_______________________________________Compound Investment Calculator________________________________\n")
                        ...
                        creativemodule4quotes.rand_quote()
                        print("_____________________________________________________________________________________________________\n")
                        print(f"_________________________________________Simple Investment Calculator________________________________\n")
...
#############################################################################################################################    
         ...
         while True:
            print("____________________________________________CREATIVE INNOVATORS______________________________________")
            print("____________________________________________FINANCIAL CALCULATOR_____________________________________")
            print("___________________________________________NB. Period is in years____________________________________")
            ...
            if choice == '1':# Investment
                print(f"____________________________________________Investment Calculator___________________________________\n")
                while True:
                    option= input('1). Compound Investment \n2). Simple Investment \n3). Exit \n____________________________________________________________________________________________________\n Option :' )
                    option = option.replace(" ","").strip()
                    if option == '1':#Compound
                        print(f"________________________________________Compound Investment Calculator______________________________\n")
                        def compound_interest_calculator(initial, rate, time):
                            P =initial
                            r=rate/100
                            t= time
                        ...
                        print(f"______________________________________Simple Investment Calculator___________________________________\n")
                        def simple_interest_calculator(initial, rate, time):
                            P = initial
                            r = rate/100
                            t = time
                ...
                print("____________________________________________________________________________________________________")
                print(f"_______________________________Home Loan yearly Payment Calculator__________________________________\n")
                print("____________________________________________________________________________________________________")
                def loan_repayment_calculator(initial, rate, time):
                    monthly_interest = rate / 1200
